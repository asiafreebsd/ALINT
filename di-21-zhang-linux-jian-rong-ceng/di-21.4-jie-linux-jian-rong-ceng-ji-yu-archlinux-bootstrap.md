...
在 pacman.conf 中取消注释 DisableSandbox 选项：
...
使用 pacman 安装基本系统、开发工具、文本编辑器 nano、AUR 助手 yay 和文泉驿字体 wqy-zenhei：
...
case $answer in
	...
	[Yy][Ee][Ss]|[Yy]|"")
		...
		chroot ${rootdir} /bin/bash -c "pacman -S --noconfirm yay base base-devel nano yay wqy-zenhei"  # 安装软件
